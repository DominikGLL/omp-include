...
[![sampctl](https://img.shields.io/badge/sampctl-omp--include-2f2f2f.svg?style=for-the-badge)](https://github.com/DominikGLL/omp-include)
...
```bash
sampctl package install DominikGLL/omp-include
```
